...
const Image = ({
                   id = 'Image', style, children, avatar, shadow, rounded, background, radius, color, height, width,
                   transform, padding, paddingVertical, paddingHorizontal, paddingRight, paddingLeft, paddingTop,
                   paddingBottom, margin, marginVertical, marginHorizontal, marginRight, marginLeft, marginTop,
                   marginBottom, ...props
               }: IImageProps) => {
